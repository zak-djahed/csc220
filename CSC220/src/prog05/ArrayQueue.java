...
public class ArrayQueue<E> extends AbstractQueue<E>
    ...
    public E poll () {
        ...
        E val1 = theElements[first % theElements.length];
        ++first;
        return val1;
    ...
    protected class Iter implements Iterator<E> {
        ...
        public E next () {
            ...
            E returnValue = theElements[index % theElements.length];
            index++;
            return returnValue;
            // EXERCISE
    ...
    protected void reallocate () {
        ...
        int n = 0;
        for(E e: this){
            newElements[n] = theElements[(n+first) % theElements.length];
            n++;
        }
        // EXERCISE
